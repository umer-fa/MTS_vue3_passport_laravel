    ...
    <div class="nav-header">
        <router-link to="/dashboard" class="brand-logo">
            ...
            <div class="brand-title">
                <h2 class="">Pass.</h2>
                <span class="brand-sub-title">Test</span>
            </div>
        </router-link>
                ...
                <div class="collapse navbar-collapse justify-content-between">
                    ...
                    <ul class="navbar-nav header-right">
                        ...
                        <li class="nav-item dropdown  header-profile">
                            <div class="dropdown">
                                <img onclick="myFunction()" class="dropbtn" src="fillow/images/user.jpg" width="56" alt=""/>
                                <div id="myDropdown" class="dropdown-content dropdown-menu dropdown-menu-end">
                        ...
                        <!--<li class="nav-item dropdown  header-profile">-->
                            <!--<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">-->
                                <!--<img src="fillow/images/user.jpg" width="56" alt=""/>-->
                            <!--</a>-->
